...
public class BasicDocument extends Document 
{
	...
	public static void main(String[] args)
	{
		...
		testCase(new BasicDocument("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad."),
		         32, 15, 1);
		BasicDocument doc = new BasicDocument("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad.");
		int wordCount = doc.getNumWords();
		int sylCount = doc.getNumSyllables();
		int senCount = doc.getNumSentences();
		System.out.println(String.format("%d %d %d", wordCount, sylCount, senCount));
